      ...
      <Container fluid className='bg-light text-black border'>
        <Row>
          ...
          <Col xs="11" md="3" className="p-0 h-100">
            ...
            <Row className="bg-light border ps-3">Average heartrate: {activity.average_heartrate ? activity.average_heartrate : "N/A"}</Row>
            ...
            <Row className="bg-white fw-light border ps-3">Max heartrate: {activity.max_heartrate ? activity.max_heartrate : "N/A"}</Row>
            ...
            <Row className="bg-white fw-light border ps-3">Average cadence: {activity.average_cadence ?activity.average_cadence : "N/A"}</Row>
